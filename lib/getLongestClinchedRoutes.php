...
// build the SQL query
$sql = "select r.root, r.region, r.route, r.banner, r.city, round(r.mileage,4) as mileage from routes as r left join clinchedRoutes as cr on r.root=cr.route and traveler='".$params['traveler']."' join systems as s on s.systemName=r.systemName";
