...
// globals traveler and distanceUnits and store the cookies
// accordingly, also the header traveler name if it exists
function setUserUnitsCookiesAndHeader() {
    ...
    const headertravspan = document.getElementById("tmusertext");
    if (headertravspan != null) {
        headertravspan.innerHTML = traveler;
    }
}
