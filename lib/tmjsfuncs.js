...
// some map options, early ones based on
...
function getBlankURL() {
	return '/lib/empty.gif';
}


var intersectionimage = {
    url: '/lib/Intersection.png',
...
function MarkerInfo(i, wpt) {
    ...
    return '<p style="line-height:160%;"><span style="font-size:24pt;color:black;">' + wpt.label + '</span><br><b>Waypoint ' + (i+1) + '<\/b><br><b>Coords.:<\/b> ' + wpt.lat + '&deg;, ' + wpt.lon + '&deg;<\/p>' + intersections;
