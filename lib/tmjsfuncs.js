...
// variables to be set by the callback function below, set with
...
Zoom level: [Far]<input id="zoomvalinput" name="zoomvalinput" type="range" min="8" max="15" value="` + setzoom + `" step="1" size="2" />[Close]
</p>
`,
	    prompt: {
		buttonAction: "OK",
