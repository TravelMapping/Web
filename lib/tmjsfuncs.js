...
*/
    ...
    fetch('https://travelmapping.net/americana/tilejson.json')
	.then(res => res.json())
	.then(tilejson => {
	    const americanaVector = L.vectorGrid.protobuf(tilejson.tiles[0], {
		tileJSON: tilejson,
    ...
    baseLayers['OSM Americana'] = americanaVector;
    control.addBaseLayer(americanaVector, 'OSM Americana');
  })
  .catch(err => console.error('Americana TileJSON fetch error', err));
