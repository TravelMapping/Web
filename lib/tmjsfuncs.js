...
function mapLocationFound(e) {
	...
	console.log("mapLocationFound: created marker at " + currentLocation.toString());
    }
    else {
	currentLocationMarker.setLatLng(currentLocation);
	console.log("mapLocationFound: updated marker to " + currentLocation.toString());
    }
}
...
function posCheckboxChanged() {
	...
	console.log("Enabling map.locate");
...
function loadmap() {
    ...
    let posCheckbox = document.getElementById("posCheckbox");
    if (posCheckbox != null) {
	// TODO: try to read the cookie to set the checkbox accordingly
...
function updateMap(lat, lon, zoom)
{
	...
	console.log("Code should no longer happen!");
