...
function parseVisibleData(data) {
	...
	tablerows += '<tr onclick="window.open(\'' + link + '\')" onmouseover="mapviewRouteHover(' + routeroots[i] + ')" onmouseout="mapviewRouteEndHover()"><td class="routeName">' + routelistnames[i] + '</td><td class="clinched">TBD</td><td class="overall">' + routemileages[i] + '</td><td class="percent">TBD</td></tr>';
    }
